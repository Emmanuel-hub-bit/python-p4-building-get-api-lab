...
def bakery_by_id(id):
    # Return a single bakery with nested baked goods
    bakery = Bakery.query.get_or_404(id)
    return jsonify(bakery.to_dict_with_baked_goods()), 200

@app.route('/baked_goods/by_price')
def baked_goods_by_price():
    # Return baked goods sorted by price in descending order
